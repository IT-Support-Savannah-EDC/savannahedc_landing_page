                            ...
                            <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                                ...
                                <tr>
                                    <td style="padding: 30px 30px 15px 30px; border-bottom: 1px solid #F1F5F9;">
                                        ...
                                        <a href="https://savannahedc.com" style="vertical-align: middle; font-size: 20px; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; text-decoration: none; color: #004DC2;">Savannah Electricity Distribution Company</a>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #0A1931; text-align: center;">
                                  <tr>
